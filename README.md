...
![Library_project](https://github.com/SARANYA-NATRAYAN/SQL_LIBRARY-MANAGEMENT/blob/main/library_img.png)

## Objectives

**Database Setup for the Library Management System**: Design and populate the database with tables covering branches, employees, members, books, book issued status, and return records.
**CRUD Operations**: Execute Create, Read, Update, and Delete actions to manage the data effectively.
**CTAS (Create Table As Select)**: Apply CTAS to create new tables from the results of existing queries.
**Advanced SQL Queries**:Develop complex queries to analyze data and extract targeted information.
...
```sql
CREATE DATABASE sql_project_p2_library;
